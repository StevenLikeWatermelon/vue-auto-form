...
(function (global, factory) {
  ...
  var upload = {
    ...
    render: function render() {
      ...
      this.initChildren();
      return h("div", {
        "class": (_ref = {}, _defineProperty(_ref, 'fc-upload', true), _defineProperty(_ref, 'fc-hide-btn', !isShow), _ref)
  ...
  function isString$1(arg) {
    return isType$1(arg, 'String');
  }
  function isBool(arg) {
    return isType$1(arg, 'Boolean');
  }
  ...
  function isElement(arg) {
    return _typeof(arg) === 'object' && arg !== null && arg.nodeType === 1 && !isPlainObject$1(arg);
  }
    ...
    for (var key in target) {
      if (Object.prototype.hasOwnProperty.call(target, key)) {
        ...
        if ((isArr = Array.isArray(clone)) || isPlainObject$1(clone)) {
          ...
          deepExtend$1(origin[key], clone, mode);
        } else {
          $set$1(origin, key, clone);
        }
      }
  ...
  function deepExtendArgs$1(origin) {
    ...
    lst.forEach(function (target) {
      origin = deepExtend$1(origin, target);
    });
    return origin;
  }
  var id$1 = 0;
    ...
    return {
      ...
      methods: {
        _buttonProps: function _buttonProps(props) {
          this.$set(this, 'buttonProps', deepExtend$1(this.buttonProps, props));
        },
        _resetProps: function _resetProps(props) {
          this.$set(this, 'resetProps', deepExtend$1(this.resetProps, props));
        },
      ...
      for (var key in b) {
        if (a[key]) {
          if (normalMerge$1.indexOf(key) !== -1) {
            a[key] = _objectSpread2$1({}, a[key], {}, b[key]);
            ...
            a[key] = [].concat(_toConsumableArray$1(arrA), _toConsumableArray$1(arrB));
            ...
            for (var event in b[key]) {
              if (a[key][event]) {
                ...
                a[key][event] = [].concat(_toConsumableArray$1(_arrA), _toConsumableArray$1(_arrB));
              } else {
  ...
  function () {
    ...
    _createClass$1(VData, [{
      ...
      value: function _class(classList) {
        ...
        if (isUndef$1(classList)) return this;

        if (Array.isArray(classList)) {
          this.merge({
            class: classList
          });
        } else if (isPlainObject$1(classList)) {
          this.merge(classList);
        } else {
          this.merge({
            class: _defineProperty$1({}, toString$1(classList), !!status)
          });
        }
      ...
      value: function get() {
        ...
        var data = Object.keys(this._data).reduce(function (initial, key) {
          ...
          if (isPlainObject$1(value) && !Object.keys(value).length && key !== 'props') return initial;
          initial[key] = value;
          return initial;
        }, {});
        this.init();
  ...
  keyList.forEach(function (key) {
    VData.prototype[key] = function (val) {
      this.merge(_defineProperty$1({}, key, val));
      return this;
    };
  });
  objList.forEach(function (key) {
    VData.prototype[key] = function (obj, val) {
      if (isUndef$1(obj)) return this;

      if (isPlainObject$1(obj)) {
        this.merge(_defineProperty$1({}, key, obj));
      } else {
        this.merge(_defineProperty$1({}, key, _defineProperty$1({}, toString$1(obj), val)));
      }
  ...
  function creatorTypeFactory(name, type) {
    ...
    return function (title, field, value) {
      ...
      if (isFunction$1(type)) type(maker);else maker.props(typeName, type);
      return maker;
    };
  }
  ...
  function (_VData) {
    ...
    function Creator(type, title, field, value) {
      ...
      if (isPlainObject$1(props)) _this.props(props);
      return _this;
    }
    ...
    _createClass$1(Creator, [{
      ...
      value: function _clone() {
        ...
        clone._data = deepExtend$1({}, this._data);
        return clone;
      }
    }, {
      key: "getRule",
  ...
  objAttrs.forEach(function (attr) {
    Creator.prototype[attr] = function (opt) {
      $set$1(this._data, attr, extend(this._data[attr], opt));
      return this;
    };
  });
  ...
  arrAttrs.forEach(function (attr) {
    Creator.prototype[attr] = function (opt) {
      ...
      $set$1(this._data, attr, this._data[attr].concat(opt));
      return this;
    };
  });
  ...
  function toJson(obj) {
    return JSON.stringify(deepExtend$1([], obj, true), function (key, val) {
  ...
  function parseJson(json, mode) {
    return JSON.parse(json, function (k, v) {
      if (isUndef$1(v) || !v.indexOf) return v;
  ...
  function copyRules(rules, mode) {
    return deepExtend$1([], rules, mode);
  }
  ...
  function parse(rule) {
    ...
    if (isString$1(rule)) rule = parseJson(rule);
    if (rule instanceof Creator) return toMaker ? rule : rule.getRule();

    if (isPlainObject$1(rule)) {
  ...
  function parseVData(data) {
    if (isString$1(data)) data = {
      domProps: {
        innerHTML: data
      }
    };else if (data && isFunction$1(data.get)) data = data.get();
    return data;
  }

  function getVNode(VNode) {
    return isFunction$1(VNode) ? VNode() : VNode || [];
  }
  ...
  function () {
    ...
    _createClass$1(BaseParser, [{
      ...
      value: function updateKey(id, parent) {
        this.key = 'key_' + id;
        parent && this.parent && this.parent.updateKey(uniqueId$1(), parent);
      }
    }, {
      key: "update",
    ...
    _createClass$1(Render, [{
      ...
      value: function renderTemplate(parser) {
        ...
        if (!this.renderList[id]) {
          var _vm = rule.vm;
          if (isUndef$1(rule.vm)) _vm = new _vue();else if (isFunction$1(rule.vm)) _vm = rule.vm(this.$handle.getInjectData(rule));
          this.renderList[id] = {
            vm: _vm,
      ...
      value: function renderParser(parser, parent) {
        ...
        if (!this.cache[parser.id] || parser.type === 'template') {
          ...
          if (type === 'template' && rule.template) {
            ...
            if (parent && isUndef$1(rule.native)) {
      ...
      value: function renderChildren(parser) {
        ...
        if (!isValidChildren(children)) {
          orgChildren.forEach(function (child) {
            if (!isString$1(child) && child.__fc__) {
        ...
        this.orgChildren[parser.id].forEach(function (child) {
          if (children.indexOf(child) === -1 && !isString$1(child) && child.__fc__) {
            _this4.$handle.removeField(child.__fc__);
          }
        });
        return children.map(function (child) {
          if (isString$1(child)) return child;
  ...
  function Api(h) {
    ...
    return {
      ...
      setValue: function setValue(field, value) {
        var formData = field;
        if (!isPlainObject$1(field)) formData = _defineProperty$1({}, field, value);
      ...
      hidden: function hidden(_hidden, fields) {
        tidyFields(fields, true).forEach(function (field) {
          var parser = h.getParser(field);
          if (!parser) return;
          $set$1(parser.rule, 'hidden', !!_hidden);
      ...
      visibility: function visibility(_visibility, fields) {
        tidyFields(fields, true).forEach(function (field) {
          var parser = h.getParser(field);
          if (!parser) return;
          $set$1(parser.rule, 'visibility', !!_visibility);
          h.$render.clearCache(parser, true);
        });
        h.refresh();
      },
      ...
      validate: function validate(callback) {
        ...
        var keys = Object.keys(subForm).filter(function (field) {
          ...
          return Array.isArray(sub) ? sub.length : !isUndef$1(sub);
        }),
            len = keys.length,
            subLen;
      ...
      submit: function submit(successFn, failFn) {
        ...
        this.validate(function (valid) {
          if (valid) {
            ...
            if (isFunction$1(successFn)) successFn(formData, _this4);else {
  ...
  function getRule(rule) {
    if (isFunction$1(rule.getRule)) return rule.getRule();else return rule;
  }
    ...
    _createClass$1(Handle, [{
      ...
      value: function loadRule(rules, parent) {
        ...
        rules.map(function (_rule, index) {
          if (parent && isString$1(_rule)) return;
      ...
      value: function createParser(rule) {
        return new (this.fc.parsers[toString$1(rule.type).toLocaleLowerCase()] || BaseParser)(this, rule, '' + uniqueId$1());
      }
    }, {
      key: "parseRule",
      value: function parseRule(_rule) {
        ...
        Object.keys(def).forEach(function (k) {
          if (!{}.hasOwnProperty.call(rule, k)) $set$1(rule, k, def[k]);
        });
      ...
      value: function parseInjectEvent(rule, on) {
        ...
        if (this.options.injectEvent || rule.inject) Object.keys(on).forEach(function (k) {
          if (isFunction$1(on[k])) on[k] = _this3.inject(rule, on[k]);
        });
        return on;
      }
    }, {
      ...
      value: function setParser(parser) {
        ...
        if (name) $set$1(this.customData, name, parser);
        if (this.isNoVal(parser)) return;
        this.fieldList[field] = parser;
        $set$1(this.formData, field, parser.toFormValue(rule.value));
        $set$1(this.validate, field, rule.validate || []);
        $set$1(this.trueData, field, parser);
      }
    }, {
      key: "addSubForm",
        ...
        Object.keys(parser.rule).forEach(function (key) {
          ...
          try {
            parser.watch.push(vm.$watch(function () {
              ...
              if (key === 'hidden' && (!parser.isDef || parser.rule.native !== false)) parser.updateKey(uniqueId$1(), true);else if (key === 'validate') _this6.validate[parser.field] = n;else if (key === 'props') _this6.parseProps(parser.rule);else if (key === 'on') _this6.parseOn(parser.rule);else if (key === 'emit') _this6.margeEmit(parser.rule);
      ...
      value: function mountedParser() {
        ...
        Object.keys(this.parsers).forEach(function (id) {
          ...
          if (parser.defaultValue === undefined) parser.defaultValue = deepExtend$1({}, {
            value: parser.rule.value
          }).value;
      ...
      value: function reloadRule(rules) {
        ...
        var parsers = _objectSpread2$1({}, this.parsers);
        ...
        this.$render.initOrgChildren();
        this.formData = _objectSpread2$1({}, this.formData);
        this.created();
      ...
      value: function setFormData(parser, value) {
        $set$1(this.formData, parser.field, value);
      }
    }, {
      key: "getFormData",
  ...
  function getControl(parser) {
    ...
    if (isPlainObject$1(control)) return [control];else return control;
  }
  ...
  function createFormCreate(drive) {
    var components = _defineProperty$1({}, fragment.name, fragment),
        parsers = {},
        maker = makerFactory(),
    ...
    function createParser() {
      return (
        ...
        function (_BaseParser) {
          _inherits$1(Parser, _BaseParser);

          function Parser() {
            _classCallCheck$1(this, Parser);

            return _possibleConstructorReturn$1(this, _getPrototypeOf$1(Parser).apply(this, arguments));
          }
    ...
    function margeGlobal(config, _options) {
      ...
      var options = deepExtend$1(config, _options);
      $set$1(options, 'el', !options.el ? window.document.body : isElement(options.el) ? options.el : document.querySelector(options.el));
      return options;
    }
    ...
    function () {
      function FormCreate(rules) {
        ...
        this.options = margeGlobal(deepExtend$1({
          formData: {}
      ...
      _createClass$1(FormCreate, [{
        ...
        value: function install(Vue, options) {
          if (options && isPlainObject$1(options)) margeGlobal(globalConfig, options);
  ...
  function () {
    ...
    _createClass$1(BaseForm, [{
      ...
      value: function getGetCol(parser) {
        ...
        col = deepExtendArgs$1({}, mCol, pCol, col);
        return col;
      }
    }, {
      key: "beforeRender",
  ...
  var Parser$2 = /*#__PURE__*/function (_BaseParser) {
    ...
    _createClass(Parser, [{
      ...
      value: function init() {
        var props = this.rule.props;
        if (props && props.autosize && props.autosize.minRows) $set(props, 'rows', props.autosize.minRows || 2);
      }
    }]);
  ...
  var maker$3 = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, datePicker$1), maker), maker$1), select$2), slider$1), timePicker$1), tree$2), maker$2),
